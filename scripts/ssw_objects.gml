...
if plat=0 draw_background_part_ext(global.everysheet[biome],lx+frx*16+8,fry*16+8,w*16,h*16,floor(x-frox*xsc)+notex,floor(y-froy*ysc)+dy+notey,xsc,ysc,$ffffff,1)
