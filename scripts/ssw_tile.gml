...
var frox,froy, frx,fry, fr,ffr4,fr8,fr88, xsc,ysc,w,h, lx, plat;
...
if plat=0 draw_background_part_ext(global.everysheet[biome],lx+frx*16+8,fry*16+8,w*16,h*16,floor(x-frox*xsc)+notex,floor(y-froy*ysc)+notey+dy,xsc,ysc,$ffffff,alpha)
if (plat!=0) draw_background_part_ext(global.everysheet[biome],lx+(frx+2)*16+8,fry*16+8,16,16,floor(x-frox*xsc+plat*16*xsc),floor(y-froy*ysc)+dy,xsc,ysc,$ffffff,1)
